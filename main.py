...
carimg=pygame.image.load('data/car1.jpg')
backgroundpic=pygame.image.load("data/download12.jpg")
yellow_strip=pygame.image.load("data/yellow strip.jpg")
strip=pygame.image.load("data/strip.jpg")
intro_background=pygame.image.load("data/background.jpg")
instruction_background=pygame.image.load("data/background2.jpg")
car_width=56
pause=False
...
def obstacle(obs_startx,obs_starty,obs):
    if obs==0:
        obs_pic=pygame.image.load("data/car.jpg")
    elif obs==1:
        obs_pic=pygame.image.load("data/car1.jpg")
    elif obs==2:
        obs_pic=pygame.image.load("data/car2.jpg")
    elif obs==3:
        obs_pic=pygame.image.load("data/car4.jpg")
    elif obs==4:
        obs_pic=pygame.image.load("data/car5.jpg")
    elif obs==5:
        obs_pic=pygame.image.load("data/car6.jpg")
    elif obs==6:
        obs_pic=pygame.image.load("data/car7.jpg")
